# robust_iswap_polish_3lvl.jl
# Warm-started 3-lvl-per-qubit polish of the robust iSWAP trajectory.
# Loads the saved 4-dim warm-start, lifts to 9-dim, optimizes with n̂_1, n̂_2, n̂_1·n̂_2 robustness.
...
const PROFILE_LOG      = joinpath(@__DIR__, "ipopt_$(POLISH_TAG)_profile.log")
const PROFILE_TRAJ     = joinpath(@__DIR__, "traj_$(POLISH_TAG)_profile.jld2")
